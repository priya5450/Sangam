...
//             <img src={course.image} alt={course.title} className="rounded-lg w-full h-40 object-cover"/>
//             <h2 className="text-xl font-semibold mt-2">{course.title}</h2>
//             <p className="text-gray-600 mt-1">{course.description}</p>
//             <Link
//               to={course.contentUrl}
//               className="block mt-4 text-center bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700"
//             >
//               View Content
//             </Link>
//           </div>
